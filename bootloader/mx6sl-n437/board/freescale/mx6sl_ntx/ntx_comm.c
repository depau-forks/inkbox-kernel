...
static int _detect_bootmode(void)
{
	...
	gptNtxHwCfg->m_val.bKeyPad=12;
	gptNtxHwCfg->m_val.bAudioCodec=0;
	gptNtxHwCfg->m_val.bAudioAmp=0;
	gptNtxHwCfg->m_val.bWifi=7;
	gptNtxHwCfg->m_val.bBT=0;
	gptNtxHwCfg->m_val.bMobile=0;
	gptNtxHwCfg->m_val.bTouchCtrl=11;
	gptNtxHwCfg->m_val.bTouchType=4;
	gptNtxHwCfg->m_val.bDisplayCtrl=7;
	gptNtxHwCfg->m_val.bDisplayPanel=6;
	gptNtxHwCfg->m_val.bRSensor=0;
	gptNtxHwCfg->m_val.bMicroP=2;
	gptNtxHwCfg->m_val.bCustomer=9;
	gptNtxHwCfg->m_val.bBattery=1;
	gptNtxHwCfg->m_val.bLed=5;
	gptNtxHwCfg->m_val.bRamSize=3;
	gptNtxHwCfg->m_val.bIFlash=0;
	gptNtxHwCfg->m_val.bExternalMem=0;
	gptNtxHwCfg->m_val.bRootFsType=2;
	gptNtxHwCfg->m_val.bSysPartType=2;
	gptNtxHwCfg->m_val.bProgressXHiByte=0x01;
	gptNtxHwCfg->m_val.bProgressXLoByte=0x68;
	gptNtxHwCfg->m_val.bProgressYHiByte=0x02;
	gptNtxHwCfg->m_val.bProgressYLoByte=0xe4;
	gptNtxHwCfg->m_val.bProgressCnts=0x00;
	gptNtxHwCfg->m_val.bContentType=0x00;
	gptNtxHwCfg->m_val.bCPU=5;
	gptNtxHwCfg->m_val.bUIStyle=1;
	// gptNtxHwCfg->m_val.bRAMType=5;
	gptNtxHwCfg->m_val.bUIConfig=0;
	gptNtxHwCfg->m_val.bDisplayResolution=5;
	gptNtxHwCfg->m_val.bFrontLight=11;
	gptNtxHwCfg->m_val.bCPUFreq=0;
	gptNtxHwCfg->m_val.bHallSensor=1;
	gptNtxHwCfg->m_val.bDisplayBusWidth=0;
	// gptNtxHwCfg->m_val.bFrontLight_Flags=BootON:OFF,TABLE1X:OFF,EN_INV:OFF;
	// gptNtxHwCfg->m_val.bPCB_Flags=NO_KeyMatrix:ON,FPC_Touch:OFF,LOGO_LED:OFF,RD_MODE:OFF,EPD_LV:OFF,EPDVDD_STDALONE:OFF,HP_DETECT:OFF,ISD_1V8:OFF;
	// gptNtxHwCfg->m_val.bFrontLight_LEDrv=0;
	gptNtxHwCfg->m_val.bVCOM_10mV_HiByte=0x00;
	gptNtxHwCfg->m_val.bVCOM_10mV_LoByte=0x00;
	gptNtxHwCfg->m_val.bPCB_REV=0x10;
	gptNtxHwCfg->m_val.bPCB_LVL=0;
	gptNtxHwCfg->m_val.bHOME_LED_PWM=0;
	gptNtxHwCfg->m_val.bPMIC=1;
	gptNtxHwCfg->m_val.bFL_PWM=0;
	gptNtxHwCfg->m_val.bRTC=1;
	// gptNtxHwCfg->m_val.bBootOpt=ESD:OFF;
	gptNtxHwCfg->m_val.bTouch2Ctrl=0;
	gptNtxHwCfg->m_val.bTouch2Type=0;
	// gptNtxHwCfg->m_val.bGPS=0;
	// gptNtxHwCfg->m_val.bFM=0;
	// gptNtxHwCfg->m_val.bRSensor2=0;
	// gptNtxHwCfg->m_val.bLightSensor=0;
	// gptNtxHwCfg->m_val.bTPFWIDByte0=0x00;
	// gptNtxHwCfg->m_val.bTPFWIDByte1=0x00;
	// gptNtxHwCfg->m_val.bTPFWIDByte2=0x00;
	// gptNtxHwCfg->m_val.bTPFWIDByte3=0x00;
	// gptNtxHwCfg->m_val.bTPFWIDByte4=0x00;
	// gptNtxHwCfg->m_val.bTPFWIDByte5=0x00;
	// gptNtxHwCfg->m_val.bTPFWIDByte6=0x00;
	// gptNtxHwCfg->m_val.bTPFWIDByte7=0x00;
	// gptNtxHwCfg->m_val.bGPU=0;
	// gptNtxHwCfg->m_val.bPCB_Flags2=eMMC@SD1:OFF,WiFi@SD2:OFF,eMMC@SD2:OFF;
	// gptNtxHwCfg->m_val.bEPD_Flags=NO_VDD_CTRL:OFF,LP_PANEL:OFF;
	// gptNtxHwCfg->m_val.bLAN=0;
	// gptNtxHwCfg->m_val.bMobileIF=0;
	// gptNtxHwCfg->m_val.bPIR=0;
	// gptNtxHwCfg->m_val.bPanelLaminationSrc=0;
	// gptNtxHwCfg->m_val.bFL_CHNS=0x00;
#endif
