		 ...
		 u32 crop_h)
{
	...
	if (fmt == V4L2_PIX_FMT_Y8) {
		...
		MDP_REG_MASK(MDP_VIDO_STRIDE, pitch, 0x3fff);
	} else if (fmt == V4L2_PIX_FMT_Y1_M0) {
		MDP_REG_MASK(MDP_VIDO_Y_MODE, 0x3, 0xf);
		MDP_REG_MASK(MDP_VIDO_STRIDE, pitch, 0x3fff);
	} else if (fmt == V4L2_PIX_FMT_Y1_M1) {
		MDP_REG_MASK(MDP_VIDO_Y_MODE, 0x5, 0xf);
		MDP_REG_MASK(MDP_VIDO_STRIDE, pitch, 0x3fff);
	} else {
		MDP_REG_MASK(MDP_VIDO_Y_MODE, 0x0, 0xf);
		MDP_REG_MASK(MDP_VIDO_STRIDE, pitch, 0x3fff);
