...
#else   
#define MAXIAM_DBG(x...) pr_debug(x)
#endif 
...
#define MOISTDET_CTRL_MAN_EN     BIT(2) /* MoistDetCtrl 2 */
#define MOISTDET_CTRL_PER_EN     BIT(3) /* MoistDetCtrl 2 */
#define MOISTDET_CTRL_AUTO_EN     BIT(4) /* MoistDetCtrl 2 */


#define MAX20342_ADC_CTRL2     0x5D
#define MAX20342_MOIST_ADCRESULT_AVG     0x60
...
struct max20342_data {
	...
	struct delayed_work	moist_det_work;
	int mode_configuring ;
	int iMoistDetectedLvl;
	struct completion irqwork_completion;
};
