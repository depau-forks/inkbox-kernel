 ...
 * @param[out] isColorBuffer The color boolean buffer for CSR.
 * @param[in] gain enhance number, 1 ~ 2.
 ...
 * @return EInk Error Massage
 */
EInkRenderErrMsg eink_color_mapping_Gain(unsigned char *color_buffer, ImageFormat inputType, unsigned char *gray_buffer, uint32_t width, uint32_t height, unsigned char *isColorBuffer, unsigned int gain, uint32_t left, uint32_t top, uint32_t right, uint32_t bottom, int rotate);
 ...
 * @return EInk Error Massage
 */
EInkRenderErrMsg eink_color_mapping_AIE(unsigned char *color_buffer, ImageFormat inputType, unsigned char *gray_buffer, uint32_t width, uint32_t height, unsigned char *isColorBuffer, unsigned char *lut, uint32_t left, uint32_t top, uint32_t right, uint32_t bottom, int rotate);
