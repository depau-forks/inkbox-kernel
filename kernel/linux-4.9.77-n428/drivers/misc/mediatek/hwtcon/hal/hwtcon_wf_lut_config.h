...
// waveform mode mapping between user,driver,eink .
struct wf_mode_map {
	char *szUser_wfm_name; // waveform mode name for user layer . 
	int iUser_wfm; // waveform mode for user layer . 
	int iMtk_wfm; // waveform mode for MTK driver layer . 
	int iEink_wfm;	// waveform mode for Eink waveform file . 
};

// waveform mode mapping table 
struct wf_mode_map_tab {
	unsigned char bModeVer; // waveform mode version of the waveform file . 
	int iItems; // total waveform modes of the waveform file . 
	struct wf_mode_map *ptItems; // waveform modes table . 
};
