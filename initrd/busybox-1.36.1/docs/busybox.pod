...
Currently available applets include:
	...
	acpid, add-shell, addgroup, adduser, adjtimex, arp, arping, ascii,
	ash, awk, base32, base64, basename, bc, beep, blkdiscard, blkid,
	blockdev, bootchartd, brctl, cal, cat, chat, chattr, chgrp, chmod,
	chown, chpasswd, chpst, chroot, chrt, chvt, clear, cmp, conspy, cp,
	...
	echo, ed, egrep, eject, env, envdir, envuidgid, ether-wake, factor,
	...
	ftpget, ftpput, fuser, getopt, getty, grep, halt, hd, hdparm,
	hexdump, hexedit, hostname, httpd, hush, hwclock, i2cdetect,
	i2cdump, i2cget, i2cset, i2ctransfer, ifconfig, ifdown, ifenslave,
	ifplugd, ifup, inetd, init, insmod, ionice, iostat, ip, ipaddr,
	ipcalc, ipcrm, ipcs, iplink, ipneigh, iproute, iprule, iptunnel,
	kbd_mode, kill, killall, killall5, last, less, linux32, linux64,
	linuxrc, ln, loadkmap, login, losetup, lpd, lpq, lpr, ls, lsattr,
	lsmod, lsof, lspci, lsscsi, lsusb, makedevs, makemime, man, mdev,
	...
	nandwrite, nbd-client, nc, netstat, nmeter, nologin, nsenter,
	nslookup, ntpd, openvt, partprobe, passwd, patch, pgrep, pidof,
	ping, ping6, pivot_root, pkill, pmap, popmaildir, poweroff,
	...
	rtcwake, run-init, runlevel, runsv, runsvdir, rx, script,
	scriptreplay, sed, sendmail, seq, setarch, setconsole, setfattr,
	setkeycodes, setlogcons, setpriv, setserial, setsid, setuidgid, sh,
	sha256sum, showkey, shred, shuf, slattach, sleep, smemcap,
	softlimit, ssl_client, strings, su, sulogin, sv, svc, svlogd, svok,
	swapoff, swapon, switch_root, sync, sysctl, taskset, tc, tcpsvd,
	telnet, telnetd, tftp, tftpd, time, top, touch, tr, traceroute,
	traceroute6, tree, true, truncate, ts, tsort, ttysize, tunctl,
	udhcpc, udhcpc6, udhcpd, udpsvd, uevent, umount, uname, unix2dos,
	unlink, unshare, uptime, users, uuencode, vconfig, vi, vlock,
	volname, w, wall, watch, watchdog, wc, wget, which, who, whoami,
	whois, xargs, xxd, yes, zcip
